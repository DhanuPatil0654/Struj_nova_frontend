          ...
          <div className="charger-card m-2">
            <div className="card-body">
              ...
              <div className="card-header">
                <h2 className="card-title">StrujNova Energy – DC Fast Charger (120 kW)</h2>
              ...
              <p>
                StrujNova’s 120 kW DC Fast Charger is designed for high-demand public charging stations, highway corridors, fleet hubs, and commercial fast-charging locations where rapid charging and high throughput are critical. Engineered with high-density industrial power modules, advanced thermal management, and robust safety architecture, it delivers ultra-fast, stable, and efficient DC charging for next-generation electric vehicles and large battery packs.
                With OCPP-based smart connectivity, seamless backend integration, and a rugged outdoor-ready design, the 120 kW charger enables scalable, reliable, and future-proof EV charging infrastructure.
              </p>
